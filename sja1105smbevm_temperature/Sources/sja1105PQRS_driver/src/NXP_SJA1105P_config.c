...
/* Port 0 --> Port 0 on switch 0 == A0 == Calypso */
/* Port 1 --> Port 2 on switch 1 == B2 */
/* Port 2 --> Port 3 on switch 1 == B3 */
/* Port 3 --> Port 0 on switch 1 == B0 */
/* Port 4 --> Port 1 on switch 1 == B1 */
/* Port 5 --> Port 1 on switch 0 == A1 */
/* Port 6 --> Port 3 on switch 0 == A3 == 1000Base-T */
/* Port 7 --> Port 2 on switch 0 == A2 == 1000Base-T */
#define REFBOARD_PORT_MAPPING {{0, 0}, {1, 0}, {2, 0}, {3, 0}, {0, 1}, {1, 1}, {2, 1}, {3, 1}} /**< Mapping between logical ports used in the driver API and the physical ports on the ICs. Syntax: {{physical port of port 0, physical switch of port 0}, ...} */
/* Port 0 --> Port 0 on switch 0 == A0 == Calypso */
/* Port 1 --> Port 1 on switch 0 == A1 == 1102S */
/* Port 2 --> Port 2 on switch 0 == A2 == GBit */
/* Port 3 --> Port 3 on switch 0 == A3 == GBit */
/* Port 4 --> Port 0 on switch 1 == B0 == 1102-0 */
/* Port 5 --> Port 1 on switch 1 == B1 == 1102-1 */
/* Port 6 --> Port 2 on switch 1 == B2 == 1102-0 */
/* Port 7 --> Port 3 on switch 1 == B3 == 1102-1 */

//#define SJA1105P_REFBOARD
...
*/
extern uint8_t SJA1105P_initSwitch(uint8_t configId)
{
	uint8_t ret = 0;
	uint8_t switchId;
